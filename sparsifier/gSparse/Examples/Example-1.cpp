...
int main() {
  ...
  // Create a Graph Writer for CSV file, specify edge and weight files to write
  // to
  gSparse::GraphCSVWriter csvWriter("Examples/Example-1-edges.csv",
                                    "Examples/Example-1-weights.csv");
